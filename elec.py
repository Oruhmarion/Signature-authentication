...
genuine_image_paths = r"C:\Users\Marion\Desktop\signature authentication\ELECTRONIC SIGNATURE"
forged_image_paths = r"C:\Users\Marion\Desktop\signature authentication\ELECTRONIC FORGERY"
...
def makeCSV():
    if not (os.path.exists(r"C:\Users\Marion\Desktop\signature authentication\Features")):
        os.mkdir(r"C:\Users\Marion\Desktop\signature authentication\Features")
        print('New folder "Features" created')
    if not (os.path.exists(r"C:\Users\Marion\Desktop\signature authentication\Features\Training")):
        os.mkdir(r"C:\Users\Marion\Desktop\signature authentication\Features\Training")
        print('New folder "Features/Training" created')
    if not (os.path.exists(r"C:\Users\Marion\\Desktop\signature authentication\Features\Testing")):
        os.mkdir(r"C:\Users\Marion\Desktop\signature authentication\Features\Testing")
    ...
    for person in range(1, 7):
        ...
        with open(
                r'C:\Users\Marion\Desktop\signature authentication\Features\Training\training_' + str(person) + '.csv',
                'w') as handle:
        ...
        with open(r'C:\Users\Marion\Desktop\signature authentication\Features\Testing\testing_' + str(person) + '.csv',
                  'w') as handle:
            handle.write('ratio,cent_y,cent_x,eccentricity,solidity,skew_x,skew_y,kurt_x,kurt_y,output\n')
            # Testing set
            for i in range(3, 5):
...
def testing(path):
    ...
    if not (os.path.exists(r'C:\Users\Marion\Desktop\signature authentication\TestFeatures')):
        os.mkdir(r'C:\Users\Marion\Desktop\signature authentication\TestFeatures')
    with open(r'C:\Users\Marion\Desktop\signature authentication\TestFeatures\testcsv.csv', 'w') as handle:
...
def trainAndTest(rate=0.001, epochs=1700, neurons=7, display=True):
    ...
    for i in range(1, n + 1):
        ...
        # temp = ('00' + str(i))[-2:]
        # temp = ('00' + str(i))[-3:]
        training_path = r'C:\Users\Marion\Desktop\signature authentication\Features\Training\training_' + str(
            i) + '.csv'
        testing_path = r'C:\Users\Marion\Desktop\signature authentication\Features\Testing\testing_' + str(i) + '.csv'
    ...
    if display:
        ...
        train_avg_entry.insert(tk.END, (train_avg / n).__str__())
        test_avg_entry.delete(0, tk.END)
        test_avg_entry.insert(tk.END, (test_avg / n).__str__())
...
def authenticate(p_id, image):
    ...
    train_path = r'C:\Users\Marion\Desktop\signature authentication\Features\Training\training_' + p_id.__str__() + '.csv'
    testing("pngfile.png")
    test_path = r'C:\Users\Marion\Desktop\signature authentication\TestFeatures\testcsv.csv'
